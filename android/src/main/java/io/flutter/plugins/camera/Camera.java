...
//    previewSize = computeBestPreviewSize(cameraName, preset);
        captureSize = computeBestCaptureSize(streamConfigurationMap.getOutputSizes(ImageFormat.JPEG), 1280, 720);
        videoSize = chooseVideoSize(streamConfigurationMap.getOutputSizes(SurfaceTexture.class), 960, 540);
        previewSize = chooseOptimalSize(streamConfigurationMap.getOutputSizes(SurfaceTexture.class),
                1280, 720, captureSize);
        Log.e("yanlc", "captureSize: " + captureSize.toString() + " videoSize: " + videoSize.toString() + " previewSize: " + previewSize.toString());
    }
    ...
    private Size computeBestCaptureSize(Size[] choices, int minWidth, int minHeight) {
        ...
        for (Size option : choices) {
            if (option.getHeight() == option.getWidth() * minHeight / minWidth &&
    ...
    private Size chooseVideoSize(Size[] choices, int maxWidth, int maxHeight) {
        for (Size size : choices) {
        ...
        return Collections.max(goodEnough, new CompareSizesByArea());
    }
